...
export default function BetaBarLight() {
  return (
    <div className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white py-1.5 text-center text-sm font-medium fixed top-0 left-0 right-0 z-50 h-9 flex items-center">
